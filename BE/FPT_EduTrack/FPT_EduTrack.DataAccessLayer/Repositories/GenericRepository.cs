...
namespace FPT_EduTrack.DataAccessLayer.Repositories
{
    ...
    {
        protected FptEduTrackContext _context;

        public GenericRepository() => _context ??= new FptEduTrackContext();

        public GenericRepository(FptEduTrackContext context) => _context = context;
